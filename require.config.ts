...
let require: IRequireJsConfig = {
    ...
    paths: {
        ...
        "durelia-binding": "../durelia/durelia-binding",
        "durelia-bootstrapper": "../durelia/durelia-bootstrapper",
        "durelia-dependency-injection": "../durelia/durelia-dependency-injection",
        "durelia-dialog": "../durelia/durelia-dialog",
        "durelia-framework": "../durelia/durelia-framework",
        "durelia-logger": "../durelia/durelia-logger",
        "durelia-templating": "../durelia/durelia-templating",
